<template>
    ...
    <div class="grid grid-cols-3 place-content-center justify-center">
        <div class="cursor-pointer" 
            ...
            <p class="">{{ upgrade.name }}</p>
            <p class="self-center" :style="[main.totalPoints >= upgrade.price ? 'color: green' : 'color: red']">{{ abbreviateNumber(upgrade.price, 0) }} points</p>
        </div>
    </div>
</template>
